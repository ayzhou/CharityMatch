...
//NOT WRITTEN BY ALAN. PART OF ORIGINAL
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    private void initFromXml(AttributeSet attr) {
        TypedArray a = getContext().obtainStyledAttributes(attr,
                com.andtinder.R.styleable.CardContainer);

        setGravity(a.getInteger(com.andtinder.R.styleable.CardContainer_android_gravity, Gravity.CENTER));
        int orientation = a.getInteger(com.andtinder.R.styleable.CardContainer_orientation, 1);
